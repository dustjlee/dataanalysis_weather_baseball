...
Original file is located at
    https://colab.research.google.com/drive/1Bv7cCxuKrBSZp8s9PGjEQ_nG0LwMPbMw
"""
...
# 월별 풍속의 평균값 계산
monthly_avg_wind_speed = df_weather.groupby('yyyymm')['풍속'].mean()   #풍속, 강수량, 기온 변경해서

print(monthly_avg_wind_speed)

# 그래프 그리기
fig, ax1 = plt.subplots(figsize=(16, 10))

# 월별 풍속 dot 그래프
ax1.plot(monthly_avg_wind_speed.index.astype(str), monthly_avg_wind_speed.values, marker='o', color='blue', label='Monthly AVG wind_speed')
ax1.set_xlabel('Month')
ax1.set_ylabel('WS(m/s)', color='blue')
...
# 그래프 제목
plt.title('Montly AVG Wind_Speed & Won-Loose Graph')
