...
Original file is located at
    https://colab.research.google.com/drive/1A_UQDiT4fwFBMSDx6UchC0BDNE-fx9yL
"""
...
# 월별 강수량의 평균값 계산
monthly_avg_precipitation = df_weather.groupby('yyyymm')['강수량'].mean()   #풍속, 강수량, 기온 변경해서

print(monthly_avg_precipitation)

# 그래프 그리기
fig, ax1 = plt.subplots(figsize=(16, 10))

# 월별 강수량 dot 그래프
ax1.plot(monthly_avg_precipitation.index.astype(str), monthly_avg_precipitation.values, marker='o', color='blue', label='Monthly AVG Precipitation')
ax1.set_xlabel('Month')
ax1.set_ylabel('Pre(mm)', color='blue')
...
# 그래프 제목
plt.title('Montly AVG precipitation & Won-Loose Graph')
